                    ...
                    <div class="card-header">
                        ...
                        <form action="{{route('cmf.dc.store',['slug' => $cmf->slug])}}" method="post">
                            ...
                            <div class="form-floating my-4">
                                <textarea class="form-control" name="catatan" placeholder="Leave a note here" id="catatan">{{$step->catatan ?? ''}}</textarea>
                    ...
                    <div class="card-header">
                        <form action="{{route('cmf.dc.store',['slug' => $cmf->slug])}}" method="post">
                            ...
                            <div class="form-floating mb-4">
                                <textarea class="form-control" name="catatan" placeholder="Leave a note here" id="catatan"></textarea>
